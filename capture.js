 ...
 */
   ...
   function writeMediaSection(transceiver, caps, type, stream, dtlsRole) {
    ...
    transceiver.dtlsTransport.getLocalParameters(), type === 'offer' ? 'actpass' : dtlsRole || 'active');
      ...
      if (description.type === 'offer' && !rejected) {
       ...
       if (direction === 'sendrecv' || direction === 'sendonly') {
        ...
        if (isNewTrack) {
         ...
         default) {
           streams.
          default = new window.MediaStream();
          }
          stream = streams.
         default;
         }
       ...
       if (rtpReceiver && (direction === 'sendrecv' || direction === 'sendonly')) {
        ...
        default.addTrack(track);
         receiverList.push([track, rtpReceiver, streams.
        default]);
        }
       } else {
...
/* not yet
    ...
    RTCPeerConnection.prototype.createAnswer = function() {
     ...
     this.transceivers.forEach(function(transceiver, sdpMLineIndex) {
      ...
      transceiver.localCapabilities, transceiver.remoteCapabilities);
  ...
  2: [function(require, module, exports) { /* eslint-env node */
   'use strict';
   ...
   SDPUtils.parseRtpParameters = function(mediaSection) {
    ...
    for (var i = 3; i < mline.length; i++) { // find all codecs from mline[3..]
     ...
     if (rtpmapline) {
      ...
      mediaSection, 'a=rtcp-fb:' + pt + ' ').map(SDPUtils.parseRtcpFb);
   ...
   SDPUtils.writeMediaSection = function(transceiver, caps, type, stream) {
    ...
    // Map DTLS parameters to SDP.
    sdp += SDPUtils.writeDtlsParameters(
    transceiver.dtlsTransport.getLocalParameters(), type === 'offer' ? 'actpass' : 'active');
